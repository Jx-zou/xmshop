...
const String heightJavaScript =
    'document.querySelector("#webView").offsetHeight';
...
class _DynamicHeightWebViewState extends State<DynamicHeightWebView> {
  ...
  void _updateHeight() async {
    int height = await webViewController
        .runJavaScriptReturningResult(heightJavaScript) as int;
  ...
  void _init() {
    ...
    webViewController.setNavigationDelegate(
      NavigationDelegate(
        onPageFinished: (String url) => _updateHeight(),
      ),
    );

    ...
    return Obx(() => Stack(children: [
          SingleChildScrollView(
              ...
              child: Column(children: [
                ProductDetailsSwitchView(key: controller.tannerTitles[0]['contentKey']),
                ProductDetailsEvaluateView(key: controller.tannerTitles[1]['contentKey']),
                ProductDetailsDescriptionView(key: controller.tannerTitles[2]['contentKey']),
                ProductDetailsRecommendedView(key: controller.tannerTitles[3]['contentKey'])
              ])),
          const Positioned(bottom: 0, left: 0, right: 0, child: ProductDetailsBottomView()),

  ...
  _action({required VoidCallback onPressed, required IconData icon, EdgeInsetsGeometry? margin}) {
    return Container(
        ...
        child: RoundRectButton(
            ...
            color: Colors.black54.withOpacity(0.38 * (1 - controller.appBarOpacity.value)),
            elevation: 0,
            borderRadius: BorderRadius.circular(ScreenAdapter.fontSize(30)),
            child: Icon(icon, size: ScreenAdapter.width(40), color: controller.actionColor.value)));
  }
                            ...
                            children: [
                              ...
                              Text(value['title'],
                                  style: TextStyle(
                                      ...
                                      color: value['id'] == controller.selectedId.value ? Colors.red.withOpacity(controller.appBarOpacity.value) : Colors.black.withOpacity(controller.appBarOpacity.value))),
                              Container(
                                  margin: EdgeInsets.only(top: ScreenAdapter.height(20)),
                                  width: ScreenAdapter.width(50),
                                  height: ScreenAdapter.height(5),
                                  color: value['id'] == controller.selectedId.value ? Colors.red.withOpacity(controller.appBarOpacity.value) : Colors.transparent)
                            ]
                        )))
                        .toList()),
                centerTitle: true,
                ...
                actions: [
                  ...
                  _action(
                      onPressed: () => showMenu(
                          ...
                          shape: ContinuousRectangleBorder(borderRadius: BorderRadius.circular(ScreenAdapter.width(20))),
                          context: context,
                          position: RelativeRect.fromLTRB(ScreenAdapter.width(600), ScreenAdapter.height(250), 0, 0),

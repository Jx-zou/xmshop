...
import 'package:xmshop/app/common/views/widgets/label_button.dart';
    ...
    return controller.obx(
      (state) => Container(
          ...
          child: Stack(children: [
            Container(padding: EdgeInsets.only(bottom: ScreenAdapter.height(30)), child: GridView.builder(
